    ...
    <View style={tw`flex-1 justify-around`}>
      <View>
        <Text style={tw`text-3xl text-center font-bold my-6 text-green-600`}>
          Diveristy Among Species
        </Text>
        <Text style={tw`text-lg text-center font-semibold text-gray-700 px-4`}>
        This image is a geo-coordinate map that shows the exact coordinates for each of the trees and the corresponding species colour coded. Each colour-coded dot is unique to each colour-coded tree species in the legend.        </Text>
